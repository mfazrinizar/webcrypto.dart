...
///
/// During exploration the native conditional import points directly here, as
/// suggested by the maintainers, so implementation work can focus on matching
/// the existing [WebCryptoImpl] contract before the final Android-vs-FFI
/// selection mechanism is designed.
library;
...
import 'bindings/jca_bindings.g.dart';
